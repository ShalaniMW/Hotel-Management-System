...
<div class="content">
		...
		Customer ID <input type="text" name="cusId" value="<%=cusId%>" readonly><br>
		Hall ID <input type="text" name="hallId" value="<%=hallId%>"  readonly><br>
		Date <input type="text" name="date" value="<%=date%>" readonly><br>
		Function <input type="text" name="function" value="<%=function%>" readonly><br>
		Time Duration <input type="text" name="noOfhrs" value="<%=noOfhrs%>" readonly><br>
		Menu Type <input type="text" name="menuType" value="<%=menuType%>" readonly><br>
		No Of guests <input type="text" name="noOfguests" value="<%=noOfguests%>" readonly><br>
		
		<button type="submit" name="submit">Delete</button><br>
</div>
</fieldset>
</form>
</div>
